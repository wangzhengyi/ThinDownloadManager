...
class DownloadDispatcher extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                if (mQuit) {
                    // TODO: 2016/11/29 mTimer is need cancel here
                    // mTimer.cancel();
                    return;
                }
            }
    ...
    private void transferData(DownloadRequest request, InputStream in, OutputStream out) {
        ...
        updateDownloadStart(request, mContentLength);
    ...
    private void updateDownloadStart(DownloadRequest request, long contentLength) {
        mDelivery.postDownloadStart(request, contentLength);
    }
}
